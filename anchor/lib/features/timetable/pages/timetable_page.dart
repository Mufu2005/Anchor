...
class _TimeTablePageState extends State<TimeTablePage> {
  ...
  final List<TimeTableEntry> _allEntries = [
    TimeTableEntry(id: '1', title: "Dinner with her", time: "20:00", day: "Wednesday"),
    TimeTableEntry(id: '2', title: "Physics Class", time: "10:00", day: "Monday"),
    TimeTableEntry(id: '3', title: "Gym Leg Day", time: "18:00", day: "Wednesday"),
    TimeTableEntry(id: '4', title: "Team Meeting", time: "09:00", day: "Friday"),
  ];
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return TimeTableCard(
                    title: entry.title,
                    time: "${entry.time} 21 JAN 2025", // Hardcoded date for visual match
                    onEdit: () {},
                    onDelete: () {},
                  );
                },
